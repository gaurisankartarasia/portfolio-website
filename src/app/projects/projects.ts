...
export class Projects {
  projects = [
    {
      title: 'Synapse',
      description: 'A multi-functional web app',
    ...
    },
    {
      ...
      description:
        'A personal portfolio website for sharing custom built rom details.',
...

    {
      ...
      technologies: ['HTML5', 'CSS3', 'JavaScript', 'Bootstrap CSS'],
